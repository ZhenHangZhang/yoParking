             ...
             usingSpringWithDamping:0.65f
              initialSpringVelocity:0.5
                         ...
                         animations:^{
                             ...
                             containRect.origin.y = (weakSelf.frame.size.height - weakSelf.mainContainView.frame.size.height)/2 +40;
                             weakSelf.mainContainView.frame = containRect;
                             weakSelf.closeButton.center                 = CGPointMake(CGRectGetMaxX(weakSelf.mainContainView.frame) - weakSelf.closeButton.bounds.size.width/2,CGRectGetMinY(weakSelf.mainContainView.frame)/2 +40);
                         }
